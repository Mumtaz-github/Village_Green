...
class Products
{   
    use CreatedAtTrait; // j'ai ajouté ça ici et il va chercher en CreatedAtTrait.php et rammené ici
    use SlugTrait;
    ...
    public function __construct()
    {
        ...
        $this->created_at = new \DateTimeImmutable();  //ajouté cette ligne
    }
    ...
    // public function getCreatedAt(): ?\DateTimeImmutable  i have to delet it
    // {
