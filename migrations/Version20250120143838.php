 ...
 */
final class Version20250120143838 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void  // method up va crée base de donné ou migration
    {
    ...
    public function down(Schema $schema): void  //method down va supprimer
    {
